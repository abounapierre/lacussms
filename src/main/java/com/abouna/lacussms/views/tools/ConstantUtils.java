...
public class ConstantUtils {
    public static final String SECRET_KEY = "LACUS2017";
    public static final String SECRET_KEY_1 = "!LACUS@2017!";
    public static final String PUBLIC_KEY = "LACUS2017";
    ...
    public static String LOGO_GENU = "/images/smile2.png";
    public static String LOGO = "/images/logo-reg.png";
    public static String LOGO_1 = "/images/logo-reg.png";

    public static final String ERROR_MESSAGE = "Une erreur est survenue lors de l'éxécution de l'application";
