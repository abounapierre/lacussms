...
public class PduCodec
{
	...
	private static final char[] gsmToIsoMap; // GSM ==> ISO88591
	private static final char[] gsmToIsoExtMap;
	private static final char[] isoToGsmMap; // ISO88591 ==> GSM

	private static final char[] isoToGsmExtMap;
