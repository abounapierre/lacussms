 ...
 */
public class PrintPeriodeReportPDF {
    private final byte[] bytes;
    private static final String EMPTY_STRING = "";

    public PrintPeriodeReportPDF(ReportPDFPeriodeInputDTO input) {
        ...
        try {
            ...
            p = new Paragraph("RAPPORT DES MESSAGES ENVOYES DE LA PERIODE ALLANT DE " + input.getDateDebut() + " AU " + input.getDateFin(), titleFont);
            p.setAlignment(Element.ALIGN_CENTER);
            document.add(p);
            document.add(new Paragraph(" "));
